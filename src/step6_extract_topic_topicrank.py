...
def extract_topicrank(text: str):
    """
    The function `extract_topicrank` takes a string of text as input and returns the
    ...
    top-ranked phrases
    :type text: str
    :return: The function `extract_topicrank` returns the top-ranked phrases in the
    given text.
    """
    doc = nlp(text)
