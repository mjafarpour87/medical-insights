...
def get_list_id():
    ...
    myquery = {"ReviewLLM.Response.StringContent": {"$exists": True},"ReviewLLM.TemplateID": "extract-topic"}
...
def try_json_decoding(json_string):
    try:
        ...
        if isinstance(e,json.JSONDecodeError):
            ...
            new_response = {"StringContent": json_string,
                            "ErrorMsg" : e.msg,
                            "colno": e.colno }                   
...
if __name__ == "__main__":
    remodel_llm_response(fx_response_remodel,"extract-topic",limit_sample = 0,proccess_bar = True)